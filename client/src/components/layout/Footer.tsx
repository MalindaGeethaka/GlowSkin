    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Premium skincare products for your skin's unique needs. Transform your skincare routine with our expertly curated collection.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-glowSkin-pink transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 GlowSkin. All rights reserved. Made with ❤️ for beautiful skin.</p>
        </div>
      </div>
    </footer>
  );
